...
from cntk.learner import momentum_sgd, adagrad, adam, learning_rate_schedule, UnitType, momentum_as_time_constant_schedule
...
def train_and_evaluate(reader_train, reader_test, max_epochs, model_func):
    ...
    lr_per_minibatch       = learning_rate_schedule([1]*80 + [0.1]*40 + [0.01]*40 + [0.001], UnitType.minibatch, epoch_size)
    ...
    learner = adam(z.parameters, lr_per_minibatch, momentum_time_constant, l2_regularization_weight=l2_reg_weight)
